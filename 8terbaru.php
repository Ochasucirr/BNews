...
<body>
    ...
    <div class="all container">
        ...
        <h3 class="subtitle"><center>All the latest news is here</center></h3><br><br>
        <div class="articles-card">

            <!-- Pemanggilan seluruh berita -->
             <?php foreach ($currentPageArticles as $row): ?>
                <div>
                    <img class="new" src="<?= $row["urlToImage"]; ?>">
                    <div>
            ...
            <div class="pagination">
                ...
                for ($i = 1; $i <= $totalPages; $i++) {
                    ...
                    echo "<a href='8terbaru.php?page=$i' class='$isActive'>$i</a>";
                }
                ?>
            </div>
    </div>
